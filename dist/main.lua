...
Valentine = {
    Name = "Valentine",
    Accent = Color3.fromHex("#FF165D"),
    Dialog = Color3.fromHex("#FF4F81"),
    Outline = Color3.fromHex("#FFD6DF"),
    Text = Color3.fromHex("#FFF0F5"),
    Placeholder = Color3.fromHex("#F48FB1"),
    Background = Color3.fromHex("#FF90B3"),
    Button = Color3.fromHex("#F50057"),
    Icon = Color3.fromHex("#FF7C9C"),
},
Horizon = {
    Name = "Horizon",
